...
// 最新はここの上に追加していく
  ...
  },
  {
    ...
    title: '米コロンビア大学で開催されたUEMCONにて、シュ・ユンカンが最優秀論文賞を受賞',
    en_title: 'At the 9th IEEE Annual Ubiquitous Computing, Electronics & Mobile Communication Conference "UEMCON 2018", YunkangXu won the best paper award.',
    abstract: '11/8-10のUEMCONでシュ・ユンカンが最優秀論文賞を受賞しました。',
    en_abstract: ` YunkangXu won the best paper award.at the UEMCON 2018`,
    detail: `2018/11/8(Tur.)〜10(Sat.)、米コロンビア大学で開催されたUEMCONで、シュ・ユンカンの「オントロジーに基づいた IoTでのコミュニケーションデータ抽象手法」が「最優秀論文賞」を受賞しました。`,
  },
  {
